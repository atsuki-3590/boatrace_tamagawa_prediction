...
目標の形
レースコード,レース場,レース回,風向,風速,波の高さ,スタンド距離,
...
print("1枠_当地2連対率:", df_racelist['1枠_当地2連対率'])
print("1枠_ボート2連対率:", df_racelist['1枠_ボート2連対率'])
print("3枠_ボート2連対率:", df_racelist['3枠_ボート2連対率'])
print("1枠_級別:", df_racelist['1枠_級別'])
print("2枠_級別:", df_racelist['2枠_級別'])
print("3枠_級別:", df_racelist['3枠_級別'])
print("4枠_級別:", df_racelist['4枠_級別'])
print("5枠_級別:", df_racelist['5枠_級別'])
print("6枠_級別:", df_racelist['6枠_級別'])
