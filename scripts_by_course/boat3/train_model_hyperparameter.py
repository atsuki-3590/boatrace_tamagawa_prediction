...
# データの読み込み
modified_file_path = read_config(f"BOAT3_MODIFIED_DATA_FILE_{course_number_str}")
...
# モデルの保存
model_filename = read_config(f'BOAT3_TRAIN_DATA_pkl_{course_number_str}')
...
features_filename = read_config(f'BOAT3_TRAINED_FEATURES_pkl_{course_number_str}')
