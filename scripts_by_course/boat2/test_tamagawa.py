...
base_file_path = read_config("BOAT2_PROCESSED_DATA_FILE_05")
...
best_params = {'bootstrap': True, 'max_depth': 10, 'min_samples_leaf': 4, 'min_samples_split': 10, 'n_estimators': 300}
...
# モデルの保存
models_path = read_config("BOAT2_TRAIN_DATA_pkl_05")
