...
modified_file_path = f"data/processed_new/modified_data5.csv"
...
X = data.drop(columns=['レースコード', 'レース場', '3連複_結果'])
y = data['3連複_結果']
...
# モデルの保存
model_filename = f'models/{course_number_str}_boat5_model.pkl'
...
features_filename = f'models/{course_number_str}_trained_features_boat5.pkl'
