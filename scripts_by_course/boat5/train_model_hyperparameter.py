...
# データの読み込み
modified_file_path = read_config(f"BOAT5_MODIFIED_DATA_FILE_{course_number_str}")
...
best_params = {'bootstrap': True, 'max_depth': 10, 'min_samples_leaf': 2, 'min_samples_split': 5, 'n_estimators': 200}
...
# モデルの保存
model_filename = read_config(f'BOAT5_TRAIN_DATA_pkl_{course_number_str}')
...
features_filename = read_config(f'BOAT5_TRAINED_FEATURES_pkl_{course_number_str}')
