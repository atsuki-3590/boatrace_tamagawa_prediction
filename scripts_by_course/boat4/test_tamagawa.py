...
base_file_path = read_config("BOAT4_PROCESSED_DATA_FILE_05")
...
best_params = {'bootstrap': True, 'max_depth': 10, 'min_samples_leaf': 1, 'min_samples_split': 5, 'n_estimators': 300}
...
# モデルの保存
models_path = read_config("BOAT4_TRAIN_DATA_pkl_05")
