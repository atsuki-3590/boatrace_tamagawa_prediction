...
# データの読み込み
modified_file_path = read_config(f"BOAT4_MODIFIED_DATA_FILE_{course_number_str}")
...
best_params = {'bootstrap': True, 'max_depth': 10, 'min_samples_leaf': 2, 'min_samples_split': 10, 'n_estimators': 300}
...
# モデルの保存
model_filename = read_config(f'BOAT4_TRAIN_DATA_pkl_{course_number_str}')
...
features_filename = read_config(f'BOAT4_TRAINED_FEATURES_pkl_{course_number_str}')
