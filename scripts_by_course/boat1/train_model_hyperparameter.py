...
# データの読み込み
modified_file_path = read_config(f"BOAT1_MODIFIED_DATA_FILE_{course_number_str}")
...
best_params = {'bootstrap': True, 'max_depth': 10, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 100}
...
# モデルの保存
model_filename = read_config(f'BOAT1_TRAIN_DATA_pkl_{course_number_str}')
...
features_filename = read_config(f'BOAT1_TRAINED_FEATURES_pkl_{course_number_str}')
