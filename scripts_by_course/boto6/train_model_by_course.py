...
modified_file_path = f"data/processed_new/modified_data6.csv"
...
# モデルの保存
model_filename = f'models/{course_number_str}_boat6_model.pkl'
...
features_filename = f'models/{course_number_str}_trained_features_boat6.pkl'
