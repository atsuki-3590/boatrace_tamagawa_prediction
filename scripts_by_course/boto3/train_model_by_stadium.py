...
modified_file_path = f"data/processed_new/modified_data3.csv"
...
# モデルの保存
model_filename = f'models/{course_number_str}_boat3_model.pkl'
...
features_filename = f'models/{course_number_str}_trained_features_boat3.pkl'
